...
<span><b>SimPL</b> tokens, are now available for swap on</span> <Link href={swapUrl()} className={css.linkNews} color="turquoise" target="_blank" rel="noopener noreferrer" title="Swap SimPL Token"> <Image src={Logo} width={18} height={18} alt="pancakeswap" /> <b>PancakeSwap <small>testnets</small></b></Link>
